...
Primer magičnega kvadrata reda 3 je prikazan v tabeli \ref{table:mag 3}.

% - napis nad tabelo: Magični kvadrat reda 3
% - oznaka: table:mag3

\begin{magic}{3}{Magični kvadrat reda 3}{table:mag 3}
...
Magični kvadrat v tabeli \ref{table:mag 3} je normalen.
...
primer Euler, \cite{euler} ???. % ključ: euler
...
\begin{proof}[Dokaz izreka] %Začetek dokaza
...
%
% - napis nad tabelo: Kvadratu Lo Shukomplementarni kvadrat
...
% - napis nadtabelo: Število različnih normalnih magičnih kvadratov
