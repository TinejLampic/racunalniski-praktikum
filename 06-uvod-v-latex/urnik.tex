...
% NALOGA 1
\usepackage[slovene]{babel}  % Vključite pakete za podporo slovenščini,
\usepackage[utf8]{inputenc}   
\usepackage[T1]{fontenc}    % prepoznavo vhodnega kodiranja `utf8` in izhodnega kodiranja `T1`.
...
\begin{enumerate}
   ...
   \item Za vse proste termine $\text{predavalnica}_{\emph{j}}$ izračunamo ceno vstavljanja
   ...
   \item Ko preverimo vse proste termine vseh predavalnic, vstavimo $\text{srečanja}_{\emph{i}}$
...
seznam tabujev. V naslednjem koraku izvedemo spremembo $\text{\emph{s}}_2$, ki se prav tako shrani v
